<?php
    ...
    if(isset($_POST['login'])){
        ...
        //$db = new mysqli("localhost","root",null, "camara");
       //$db = mysqli_connect('localhost','root','','camara') or die('Error connecting to MySQL server.');
        ...
        $senha = null;
        $database = 'camara';
        $db = mysqli_connect("localhost",$user,$senha,$database)
